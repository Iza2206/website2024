                    ...
                    <form action="controllers/_ceklogin" method="post">
                        <div class="form-group">
                            ...
                            <div class="position-relative has-icon-right">
                                <input type="text" name="username_adm" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter Username" required="required">
                        ...
                        <div class="form-group">
                            ...
                            <div class="position-relative has-icon-right">
                                <input type="password" name="passwd_adm" id="myInput" class="form-control input-shadow" placeholder="Enter Password">
                                <div class="form-control-position">
                                    <i class="icon-lock"></i>
                                </div>
                            </div>
